...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("Emprunt");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.BOOK, "Emprunt", "nouveau emprunt", "consultation des comptes", "enregistremet de retour"));
        addTitle("Etudiant");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SEARCH, "Etudaint", "historique emprunt", "statistique du materiel", "Materiel", "Delai","pret Sensible"));
        addTitle("materiel");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LIST, "Materiel", "gestion materiel"));
        
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.CLOSE, "LOG OUT", "log out"));
    }
